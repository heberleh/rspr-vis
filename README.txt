...
################################################################################
modified spr_supertree to ouput list of edges and other attributes for visualization using sTVis

################################################################################


*******************************************************************************
OUTPUTING VISUALIZATION JSON FILE
*******************************************************************************

The code in this repository is equal to the original rspr (check if it updated) with an additional option for outputting a .json file containing edges and attributes. It is made for visualization using the sTVis web-tool.

To output the .json file use:
-lgt_visualization


This is an example command to read an existing Supertree and the original Trees, setting the groups of each leaf. The -initial_tree and -i 0 guarantees that the algorithm will not compute a new supertree.

./spr_supertree -allow_multi -lgt_visualization -lgt_groups ./tests/groups_class -initial_tree ./tests/SPR_MRP_Rooting.tre -i 0 < ./tests/MRP_rooted_27mil.trees



*******************************************************************************
ORIGINAL README FROM RSPR REPOSITORY
